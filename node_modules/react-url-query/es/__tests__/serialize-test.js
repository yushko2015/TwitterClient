  ...
  describe('serialization', function () {
    ...
    describe('decodeObject', function () {
      ...
      it('handles malformed input', function () {
        ...
        expect((0, _serialize.decodeObject)('foo_bar_jim_grill')).toEqual({ foo: undefined, bar: undefined, jim: undefined, grill: undefined });
      });
    });
    ...
    describe('decodeNumericObject', function () {
      ...
      it('handles malformed input', function () {
        ...
        expect((0, _serialize.decodeNumericObject)('foo_bar_jim_grill')).toEqual({ foo: undefined, bar: undefined, jim: undefined, grill: undefined });
      });
    });
